...
from thoth.messaging import __version__ as thoth_messaging_version
...
_NOTIFY_VIA_KAFKA = os.getenv("THTOH_PACKAGE_RELEASES_NOTIFY_VIA_KAFKA", 0)
...
def package_releases_update(
    ...
    *,
    ...
    if only_if_package_seen:
        ...
        package_names = graph.get_python_package_names_all(distinct=True)
